...
1. What do I know right now? (check .zap memory, saved requests, variables, active environment)
...
## The .zap Folder Is Your Brain

The .zap folder is not a dump — it is your organized working memory.
